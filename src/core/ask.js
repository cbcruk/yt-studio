...
export const MODELS = [
  ['claude-sonnet-5', 'Sonnet 5 — 기본'],
  ['claude-haiku-4-5-20251001', 'Haiku 4.5 — 빠르고 싸다'],
  ['claude-opus-5', 'Opus 5 — 까다로운 요구'],
];
...
export async function ask({
  key, model = DEFAULT_MODEL, system, user, maxTokens = 1024, fetchImpl,
}) {
